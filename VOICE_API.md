...
Если OpenAI возвращает ошибку квоты, workflow автоматически переключается на нейронные голоса Microsoft Edge и всё равно создаёт MP3 без платного API-ключа.
